...
// .wrangler/tmp/bundle-XA07ku/strip-cf-connecting-ip-header.js
...
var require_dist2 = __commonJS({
  "node_modules/no-case/dist/index.js"(exports) {
    ...
    function noCase(input, options) {
      ...
      var _a100 = options.splitRegexp, splitRegexp = _a100 === void 0 ? DEFAULT_SPLIT_REGEXP : _a100, _b = options.stripRegexp, stripRegexp = _b === void 0 ? DEFAULT_STRIP_REGEXP : _b, _c = options.transform, transform = _c === void 0 ? lower_case_1.lowerCase : _c, _d = options.delimiter, delimiter = _d === void 0 ? " " : _d;
...
// .wrangler/tmp/bundle-XA07ku/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-XA07ku/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// node_modules/@clerk/shared/dist/runtime/instance-Cze6Nv61.mjs
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
var _a;
var ClerkAPIError = /* @__PURE__ */ __name((_a = class {
  code;
  message;
  longMessage;
  meta;
...
}, __publicField(_a, "kind", "ClerkApiError"), _a), "ClerkAPIError");
var isClerkAPIError = createErrorTypeGuard(ClerkAPIError);
var _a2;
var ClerkError = (/* @__PURE__ */ __name(_a2 = class extends Error {
  clerkError = true;
  code;
  longMessage;
  docsUrl;
...
}, "ClerkError"), __publicField(_a2, "kind", "ClerkError"), _a2);
var _a3;
var ClerkAPIResponseError = (/* @__PURE__ */ __name(_a3 = class extends ClerkError {
  status;
  clerkTraceId;
  retryAfter;
  errors;
...
}, "ClerkAPIResponseError"), __publicField(_a3, "kind", "ClerkAPIResponseError"), _a3);
var isClerkAPIResponseError = createErrorTypeGuard(ClerkAPIResponseError);
var _a4;
var MissingExpiredTokenError = (/* @__PURE__ */ __name(_a4 = class extends ClerkAPIResponseError {
  /**
  ...
  */
  static is(err) {
    return isClerkAPIResponseError(err) && err.status === _a4.STATUS && err.errors.length > 0 && err.errors[0].code === _a4.ERROR_CODE;
  }
}, "MissingExpiredTokenError"), __publicField(_a4, "kind", "MissingExpiredTokenError"), __publicField(_a4, "ERROR_CODE", "missing_expired_token"), __publicField(_a4, "STATUS", 422), _a4);
...
var _a5;
var ClerkRuntimeError = (/* @__PURE__ */ __name(_a5 = class extends ClerkError {
  /**
...
}, "ClerkRuntimeError"), __publicField(_a5, "kind", "ClerkRuntimeError"), _a5);
...
var BusinessError = class extends AppError {
  constructor(message) {
    super(message, 422, "BUSINESS_RULE_VIOLATION");
  }
};
__name(BusinessError, "BusinessError");
...
_a6 = entityKind;
__publicField(ConsoleLogWriter, _a6, "ConsoleLogWriter");
var _a7;
...
_a7 = entityKind;
__publicField(DefaultLogger, _a7, "DefaultLogger");
var _a8;
...
_a8 = entityKind;
__publicField(NoopLogger, _a8, "NoopLogger");
...
_a10 = entityKind;
__publicField(Column, _a10, "Column");
...
var PgTable = class extends Table {
  /**@internal */
  [(_a11 = entityKind, InlineForeignKeys)] = [];
  /** @internal */
  [Table.Symbol.ExtraConfigBuilder] = void 0;
};
__name(PgTable, "PgTable");
__publicField(PgTable, _a11, "PgTable");
/** @internal */
...
_a12 = entityKind;
__publicField(PrimaryKeyBuilder, _a12, "PgPrimaryKeyBuilder");
var _a13;
...
_a13 = entityKind;
__publicField(PrimaryKey, _a13, "PgPrimaryKey");
...
_a14 = entityKind;
__publicField(ColumnBuilder, _a14, "ColumnBuilder");
...
_a15 = entityKind;
__publicField(ForeignKeyBuilder, _a15, "PgForeignKeyBuilder");
var _a16;
...
_a16 = entityKind;
__publicField(ForeignKey, _a16, "PgForeignKey");
...
_a17 = entityKind;
__publicField(UniqueConstraintBuilder, _a17, "PgUniqueConstraintBuilder");
var _a18;
...
_a18 = entityKind;
__publicField(UniqueOnConstraintBuilder, _a18, "PgUniqueOnConstraintBuilder");
var _a19;
...
_a19 = entityKind;
__publicField(UniqueConstraint, _a19, "PgUniqueConstraint");
...
_a20 = entityKind;
__publicField(PgColumnBuilder, _a20, "PgColumnBuilder");
var _a21;
...
_a21 = entityKind;
__publicField(PgColumn, _a21, "PgColumn");
var _a22;
...
_a22 = entityKind;
__publicField(ExtraConfigColumn, _a22, "ExtraConfigColumn");
var _a23;
...
_a23 = entityKind;
__publicField(IndexedColumn, _a23, "IndexedColumn");
var _a24;
...
_a24 = entityKind;
__publicField(PgArrayBuilder, _a24, "PgArrayBuilder");
var _a25;
...
_a25 = entityKind;
__publicField(PgArray, _a25, "PgArray");
...
_a26 = entityKind;
__publicField(PgEnumColumnBuilder, _a26, "PgEnumColumnBuilder");
var _a27;
...
_a27 = entityKind;
__publicField(PgEnumColumn, _a27, "PgEnumColumn");
...
_a28 = entityKind;
__publicField(Subquery, _a28, "Subquery");
var _a29;
var WithSubquery = class extends Subquery {
};
__name(WithSubquery, "WithSubquery");
_a29 = entityKind;
__publicField(WithSubquery, _a29, "WithSubquery");
...
_a30 = entityKind;
__publicField(FakePrimitiveParam, _a30, "FakePrimitiveParam");
...
_a31 = entityKind;
__publicField(StringChunk, _a31, "StringChunk");
var _a32;
var _SQL = class {
...
__name(Param, "Param");
_a34 = entityKind;
__publicField(Param, _a34, "Param");
...
_a35 = entityKind;
__publicField(Placeholder, _a35, "Placeholder");
...
var View = class {
  /** @internal */
  [(_a36 = entityKind, ViewBaseConfig)];
...
_a37 = entityKind;
__publicField(Relation, _a37, "Relation");
var _a38;
var Relations = class {
  constructor(table3, config2) {
    this.table = table3;
...
_a38 = entityKind;
__publicField(Relations, _a38, "Relations");
var _a39;
...
_a41 = entityKind;
__publicField(ColumnAliasProxyHandler, _a41, "ColumnAliasProxyHandler");
var _a42;
...
_a42 = entityKind;
__publicField(TableAliasProxyHandler, _a42, "TableAliasProxyHandler");
var _a43;
...
_a43 = entityKind;
__publicField(RelationTableAliasProxyHandler, _a43, "RelationTableAliasProxyHandler");
...
var QueryPromise = class {
  [(_a45 = entityKind, Symbol.toStringTag)] = "QueryPromise";
  catch(onRejected) {
...
__publicField(QueryPromise, _a45, "QueryPromise");
...
var SQLiteTable = class extends Table {
  /** @internal */
  [(_a46 = entityKind, Table.Symbol.Columns)];
  /** @internal */
  [InlineForeignKeys2] = [];
  /** @internal */
  [Table.Symbol.ExtraConfigBuilder] = void 0;
...
__publicField(SQLiteTable, _a46, "SQLiteTable");
/** @internal */
...
_a50 = entityKind;
__publicField(DrizzleError, _a50, "DrizzleError");
var _a51;
...
_a51 = entityKind;
__publicField(TransactionRollbackError, _a51, "TransactionRollbackError");
...
_a52 = entityKind;
__publicField(ForeignKeyBuilder2, _a52, "SQLiteForeignKeyBuilder");
var _a53;
...
_a53 = entityKind;
__publicField(ForeignKey2, _a53, "SQLiteForeignKey");
...
_a54 = entityKind;
__publicField(UniqueConstraintBuilder2, _a54, "SQLiteUniqueConstraintBuilder");
var _a55;
...
_a55 = entityKind;
__publicField(UniqueOnConstraintBuilder2, _a55, "SQLiteUniqueOnConstraintBuilder");
var _a56;
...
_a56 = entityKind;
__publicField(UniqueConstraint2, _a56, "SQLiteUniqueConstraint");
...
_a57 = entityKind;
__publicField(SQLiteColumnBuilder, _a57, "SQLiteColumnBuilder");
var _a58;
...
_a58 = entityKind;
__publicField(SQLiteColumn, _a58, "SQLiteColumn");
...
_a73 = entityKind;
__publicField(SQLiteViewBase, _a73, "SQLiteViewBase");
...
_a74 = entityKind;
__publicField(SQLiteDialect, _a74, "SQLiteDialect");
var _a75;
...
_a75 = entityKind;
__publicField(SQLiteSyncDialect, _a75, "SQLiteSyncDialect");
var _a76;
...
_a76 = entityKind;
__publicField(SQLiteAsyncDialect, _a76, "SQLiteAsyncDialect");
...
_a77 = entityKind;
__publicField(TypedQueryBuilder, _a77, "TypedQueryBuilder");
...
_a78 = entityKind;
__publicField(SQLiteSelectBuilder, _a78, "SQLiteSelectBuilder");
var _a79;
...
_a79 = entityKind;
__publicField(SQLiteSelectQueryBuilderBase, _a79, "SQLiteSelectQueryBuilder");
var _a80;
...
_a80 = entityKind;
__publicField(SQLiteSelectBase, _a80, "SQLiteSelect");
...
_a81 = entityKind;
__publicField(QueryBuilder, _a81, "SQLiteQueryBuilder");
...
_a82 = entityKind;
__publicField(SQLiteUpdateBuilder, _a82, "SQLiteUpdateBuilder");
var _a83;
...
_a83 = entityKind;
__publicField(SQLiteUpdateBase, _a83, "SQLiteUpdate");
...
_a84 = entityKind;
__publicField(RelationalQueryBuilder, _a84, "SQLiteAsyncRelationalQueryBuilder");
var _a85;
...
_a85 = entityKind;
__publicField(SQLiteRelationalQuery, _a85, "SQLiteAsyncRelationalQuery");
var _a86;
...
_a86 = entityKind;
__publicField(SQLiteSyncRelationalQuery, _a86, "SQLiteSyncRelationalQuery");
...
_a87 = entityKind;
__publicField(SQLiteRaw, _a87, "SQLiteRaw");
...
_a88 = entityKind;
__publicField(BaseSQLiteDatabase, _a88, "BaseSQLiteDatabase");
...
_a89 = entityKind;
__publicField(IndexBuilderOn, _a89, "SQLiteIndexBuilderOn");
var _a90;
...
_a90 = entityKind;
__publicField(IndexBuilder, _a90, "SQLiteIndexBuilder");
var _a91;
var Index = class {
  config;
...
__name(Index, "Index");
_a91 = entityKind;
__publicField(Index, _a91, "SQLiteIndex");
function index(name) {
...
_a92 = entityKind;
__publicField(ExecuteResultSync, _a92, "ExecuteResultSync");
var _a93;
...
_a93 = entityKind;
__publicField(SQLitePreparedQuery, _a93, "PreparedQuery");
var _a94;
...
_a94 = entityKind;
__publicField(SQLiteSession, _a94, "SQLiteSession");
var _a95;
...
_a95 = entityKind;
__publicField(SQLiteTransaction, _a95, "SQLiteTransaction");
...
_a96 = entityKind;
__publicField(SQLiteD1Session, _a96, "SQLiteD1Session");
var _a97;
...
_a97 = entityKind;
__publicField(D1Transaction, _a97, "D1Transaction");
...
_a98 = entityKind;
__publicField(D1PreparedQuery, _a98, "D1PreparedQuery");
...
_a99 = entityKind;
__publicField(DrizzleD1Database, _a99, "D1Database");
...
__export(schema_exports, {
  ...
  fabrics: () => fabrics,
  fabricsRelations: () => fabricsRelations,
  jobFabricLinks: () => jobFabricLinks,
  jobFabricLinksRelations: () => jobFabricLinksRelations,
  jobOrders: () => jobOrders,
  jobOrdersRelations: () => jobOrdersRelations,
  tailors: () => tailors,
  tailorsRelations: () => tailorsRelations
});
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
...
var jobFabricLinks = sqliteTable(
  "job_fabric_links",
  {
    id: text("id").primaryKey(),
    jobId: text("job_id").notNull().references(() => jobOrders.id, { onDelete: "cascade" }),
    fabricId: text("fabric_id").notNull().references(() => fabrics.id),
...
var fabricsRelations = relations(fabrics, ({ many }) => ({
  jobLinks: many(jobFabricLinks)
}));
var tailorsRelations = relations(tailors, ({ many }) => ({
  jobs: many(jobOrders)
}));
var designsRelations = relations(designs, ({ many }) => ({
  jobs: many(jobOrders)
}));
var jobOrdersRelations = relations(jobOrders, ({ one, many }) => ({
...
var jobFabricLinksRelations = relations(jobFabricLinks, ({ one }) => ({
...
// src/repositories/fabric.repository.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
var FabricRepository = class {
  ...
  async findById(id, tenantId) {
    const rows = await this.db.select().from(fabrics).where(and(eq(fabrics.id, id), eq(fabrics.tenantId, tenantId))).limit(1);
    return rows[0] ?? null;
  }
  async findByIdOrThrow(id, tenantId) {
    const fabric = await this.findById(id, tenantId);
    if (!fabric)
      throw new NotFoundError("Fabric");
    return fabric;
  }
  async findByCode(fabricCode, tenantId) {
    const rows = await this.db.select().from(fabrics).where(and(eq(fabrics.fabricCode, fabricCode), eq(fabrics.tenantId, tenantId))).limit(1);
    return rows[0] ?? null;
  }
  async findLowStock(tenantId) {
    return this.db.select().from(fabrics).where(
      and(
  ...
  async create(data) {
    ...
    const created2 = await this.findById(data.id, data.tenantId);
    if (!created2)
      throw new Error("Failed to create fabric");
    return created2;
  }
  async update(id, tenantId, data) {
    await this.db.update(fabrics).set({ ...data, updatedAt: (/* @__PURE__ */ new Date()).toISOString() }).where(and(eq(fabrics.id, id), eq(fabrics.tenantId, tenantId)));
    return this.findByIdOrThrow(id, tenantId);
  }
  async incrementReserved(id, tenantId, meters) {
    await this.db.update(fabrics).set({
      reservedQty: sql`${fabrics.reservedQty} + ${meters}`,
      updatedAt: (/* @__PURE__ */ new Date()).toISOString()
    }).where(and(eq(fabrics.id, id), eq(fabrics.tenantId, tenantId)));
  }
  async decrementReservedAndCurrent(id, tenantId, metersUsed, metersReserved) {
    await this.db.update(fabrics).set({
  ...
  async releaseReserved(id, tenantId, meters) {
    await this.db.update(fabrics).set({
  ...
  async delete(id, tenantId) {
    await this.db.delete(fabrics).where(and(eq(fabrics.id, id), eq(fabrics.tenantId, tenantId)));
  }
};
__name(FabricRepository, "FabricRepository");
...
__name(generateJobNumber, "generateJobNumber");
function now() {
...
// src/services/fabric.service.ts
var FabricService = class {
  constructor(fabricRepo) {
  ...
  async update(id, tenantId, input) {
    ...
    return this.fabricRepo.update(id, tenantId, {
      ...input.fabricCode !== void 0 && { fabricCode: input.fabricCode },
      ...input.type !== void 0 && { type: input.type },
      ...input.color !== void 0 && { color: input.color },
      ...input.supplier !== void 0 && { supplier: input.supplier },
      ...input.costPerMeter !== void 0 && { costPerMeter: input.costPerMeter },
      ...input.isClientOwned !== void 0 && { isClientOwned: input.isClientOwned },
      ...input.clientId !== void 0 && { clientId: input.clientId },
      ...input.lowStockThreshold !== void 0 && { lowStockThreshold: input.lowStockThreshold }
    });
  }
  async delete(id, tenantId) {
    await this.fabricRepo.findByIdOrThrow(id, tenantId);
...
__name(FabricService, "FabricService");

// src/validators/fabric.validator.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var createFabricSchema = external_exports.object({
  fabricCode: external_exports.string().min(1).max(50),
  type: external_exports.string().min(1).max(100),
  color: external_exports.string().max(50).optional(),
  supplier: external_exports.string().max(100).optional(),
  initialQty: external_exports.number().min(0),
  costPerMeter: external_exports.number().min(0).optional().default(0),
  isClientOwned: external_exports.boolean().optional().default(false),
  clientId: external_exports.string().optional(),
  lowStockThreshold: external_exports.number().min(0).optional().default(5)
});
var updateFabricSchema = external_exports.object({
  fabricCode: external_exports.string().min(1).max(50).optional(),
  type: external_exports.string().min(1).max(100).optional(),
  color: external_exports.string().max(50).optional(),
  supplier: external_exports.string().max(100).optional(),
  costPerMeter: external_exports.number().min(0).optional(),
  isClientOwned: external_exports.boolean().optional(),
  clientId: external_exports.string().optional(),
  lowStockThreshold: external_exports.number().min(0).optional()
});
var adjustStockSchema = external_exports.object({
...
// src/repositories/tailor.repository.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var TailorRepository = class {
  constructor(db) {
    this.db = db;
  }
  async findAll(tenantId) {
  ...
  async findActive(tenantId) {
    return this.db.select().from(tailors).where(and(eq(tailors.tenantId, tenantId), eq(tailors.isActive, true)));
  }
  async findById(id, tenantId) {
    const rows = await this.db.select().from(tailors).where(and(eq(tailors.id, id), eq(tailors.tenantId, tenantId))).limit(1);
    return rows[0] ?? null;
  }
  async findByIdOrThrow(id, tenantId) {
    const tailor = await this.findById(id, tenantId);
    if (!tailor)
      throw new NotFoundError("Tailor");
    return tailor;
  }
  async create(data) {
  ...
  async update(id, tenantId, data) {
    await this.db.update(tailors).set({ ...data, updatedAt: (/* @__PURE__ */ new Date()).toISOString() }).where(and(eq(tailors.id, id), eq(tailors.tenantId, tenantId)));
    return this.findByIdOrThrow(id, tenantId);
  }
  async incrementJobCount(id, tenantId) {
    await this.db.update(tailors).set({
      assignedJobsCount: sql`${tailors.assignedJobsCount} + 1`,
      updatedAt: (/* @__PURE__ */ new Date()).toISOString()
    }).where(and(eq(tailors.id, id), eq(tailors.tenantId, tenantId)));
  }
  async decrementJobCount(id, tenantId) {
    await this.db.update(tailors).set({
  ...
  async delete(id, tenantId) {
    await this.db.delete(tailors).where(and(eq(tailors.id, id), eq(tailors.tenantId, tenantId)));
  }
};
__name(TailorRepository, "TailorRepository");

// src/services/tailor.service.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var TailorService = class {
  constructor(tailorRepo) {
  ...
  async update(id, tenantId, input) {
    ...
    return this.tailorRepo.update(id, tenantId, {
      ...
      ...input.payRatePerPiece !== void 0 && { payRatePerPiece: input.payRatePerPiece },
...
__name(TailorService, "TailorService");

// src/validators/tailor.validator.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var createTailorSchema = external_exports.object({
  name: external_exports.string().min(1).max(100),
  phone: external_exports.string().max(20).optional(),
  payRatePerPiece: external_exports.number().min(0).optional().default(0),
  isActive: external_exports.boolean().optional().default(true)
});
var updateTailorSchema = external_exports.object({
  name: external_exports.string().min(1).max(100).optional(),
  phone: external_exports.string().max(20).optional(),
  payRatePerPiece: external_exports.number().min(0).optional(),
  isActive: external_exports.boolean().optional()
});

// src/routes/tailors.ts
var tailors2 = new Hono2();
tailors2.get("/", async (c) => {
  const db = createDb(c.env.DB);
  const service = new TailorService(new TailorRepository(db));
  const data = await service.list(c.get("tenantId"));
  return ok(c, data);
});
tailors2.get("/active", async (c) => {
  const db = createDb(c.env.DB);
  const service = new TailorService(new TailorRepository(db));
  const data = await service.listActive(c.get("tenantId"));
  return ok(c, data);
});
tailors2.get("/:id", async (c) => {
  const db = createDb(c.env.DB);
  const service = new TailorService(new TailorRepository(db));
  const data = await service.getById(c.req.param("id"), c.get("tenantId"));
  return ok(c, data);
});
tailors2.post("/", zValidator("json", createTailorSchema), async (c) => {
  const db = createDb(c.env.DB);
  const service = new TailorService(new TailorRepository(db));
  const data = await service.create(c.get("tenantId"), c.req.valid("json"));
  return created(c, data);
});
tailors2.patch("/:id", zValidator("json", updateTailorSchema), async (c) => {
  const db = createDb(c.env.DB);
  const service = new TailorService(new TailorRepository(db));
  const data = await service.update(c.req.param("id"), c.get("tenantId"), c.req.valid("json"));
  return ok(c, data);
});
tailors2.delete("/:id", async (c) => {
  const db = createDb(c.env.DB);
  const service = new TailorService(new TailorRepository(db));
  await service.delete(c.req.param("id"), c.get("tenantId"));
  return noContent(c);
});
var tailors_default = tailors2;
...
var JobRepository = class {
  ...
  async findByStatus(tenantId, status) {
    return this.db.select().from(jobOrders).where(and(eq(jobOrders.tenantId, tenantId), eq(jobOrders.status, status)));
  }
  async findActive(tenantId) {
    return this.db.select().from(jobOrders).where(
      and(
  ...
  async findById(id, tenantId) {
    const rows = await this.db.select().from(jobOrders).where(and(eq(jobOrders.id, id), eq(jobOrders.tenantId, tenantId))).limit(1);
    return rows[0] ?? null;
  }
  async findByIdOrThrow(id, tenantId) {
  ...
  async findWithRelations(id, tenantId) {
    const job = await this.findById(id, tenantId);
    if (!job)
      return null;
    const [links, tailorRow, designRow] = await Promise.all([
      this.findFabricLinks(id),
      job.tailorId ? this.db.select().from(tailors).where(eq(tailors.id, job.tailorId)).limit(1).then((r) => r[0] ?? null) : Promise.resolve(null),
      job.designId ? this.db.select().from(designs).where(eq(designs.id, job.designId)).limit(1).then((r) => r[0] ?? null) : Promise.resolve(null)
    ]);
    const linksWithFabrics = await Promise.all(
      links.map(async (link) => {
        const fabricRow = await this.db.select().from(fabrics).where(eq(fabrics.id, link.fabricId)).limit(1).then((r) => r[0]);
        return { ...link, fabric: fabricRow };
      })
    );
    return { ...job, tailor: tailorRow, design: designRow, fabricLinks: linksWithFabrics };
  }
  async findFabricLinks(jobId) {
    return this.db.select().from(jobFabricLinks).where(eq(jobFabricLinks.jobId, jobId));
  }
  async findByTailor(tailorId, tenantId) {
    return this.db.select().from(jobOrders).where(and(eq(jobOrders.tailorId, tailorId), eq(jobOrders.tenantId, tenantId)));
  }
  async create(data) {
  ...
  async update(id, tenantId, data) {
    await this.db.update(jobOrders).set({ ...data, updatedAt: (/* @__PURE__ */ new Date()).toISOString() }).where(and(eq(jobOrders.id, id), eq(jobOrders.tenantId, tenantId)));
    return this.findByIdOrThrow(id, tenantId);
  }
  async addFabricLink(data) {
    await this.db.insert(jobFabricLinks).values(data);
    const rows = await this.db.select().from(jobFabricLinks).where(eq(jobFabricLinks.id, data.id)).limit(1);
    if (!rows[0])
      throw new Error("Failed to create fabric link");
    return rows[0];
  }
  async removeFabricLinks(jobId) {
    await this.db.delete(jobFabricLinks).where(eq(jobFabricLinks.jobId, jobId));
  }
  async updateFabricLink(linkId, data) {
    await this.db.update(jobFabricLinks).set({ ...data, updatedAt: (/* @__PURE__ */ new Date()).toISOString() }).where(eq(jobFabricLinks.id, linkId));
  }
  async delete(id, tenantId) {
    await this.db.delete(jobOrders).where(and(eq(jobOrders.id, id), eq(jobOrders.tenantId, tenantId)));
  }
};
__name(JobRepository, "JobRepository");

// src/repositories/design.repository.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var DesignRepository = class {
  constructor(db) {
    this.db = db;
  }
  async findAll(tenantId) {
  ...
  async findById(id, tenantId) {
    const rows = await this.db.select().from(designs).where(and(eq(designs.id, id), eq(designs.tenantId, tenantId))).limit(1);
    return rows[0] ?? null;
  }
  async findByIdOrThrow(id, tenantId) {
  ...
  async update(id, tenantId, data) {
    await this.db.update(designs).set({ ...data, updatedAt: (/* @__PURE__ */ new Date()).toISOString() }).where(and(eq(designs.id, id), eq(designs.tenantId, tenantId)));
    return this.findByIdOrThrow(id, tenantId);
  }
  async delete(id, tenantId) {
...
__name(DesignRepository, "DesignRepository");
...
var JobService = class {
  constructor(jobRepo, fabricRepo, tailorRepo, designRepo) {
  ...
  async create(tenantId, input) {
    if (input.tailorId) {
      ...
      if (!tailor)
        throw new NotFoundError("Tailor");
      if (!tailor.isActive)
        throw new BusinessError("Cannot assign job to inactive tailor");
    }
    if (input.designId) {
  ...
  async update(id, tenantId, input) {
    ...
    await this.jobRepo.update(id, tenantId, {
      ...input.designId !== void 0 && { designId: input.designId },
      ...input.tailorId !== void 0 && { tailorId: input.tailorId },
      ...input.priority !== void 0 && { priority: input.priority },
      ...input.piecesExpected !== void 0 && { piecesExpected: input.piecesExpected },
      ...input.piecesCompleted !== void 0 && { piecesCompleted: input.piecesCompleted },
      ...input.dueDate !== void 0 && { dueDate: input.dueDate },
      ...input.notes !== void 0 && { notes: input.notes }
    });
    if (input.fabricLinks !== void 0) {
...
var TransitionService = class {
  constructor(jobRepo, fabricRepo, tailorRepo) {
    this.jobRepo = jobRepo;
    this.fabricRepo = fabricRepo;
    this.tailorRepo = tailorRepo;
  }
  async transitionJob(jobId, targetStatus, tenantId, data) {
  ...
  async handleDraftToCutting(job, tenantId) {
  ...
  async handleCuttingToSewing(job, tenantId, metersUsedEntries) {
    const links = await this.jobRepo.findFabricLinks(job.id);
    for (const link of links) {
  ...
  async handleSewingToReady(job, tenantId, piecesCompleted) {
    const completedAt = now();
    return this.jobRepo.update(job.id, tenantId, {
      status: "READY",
      completedAt,
      ...piecesCompleted !== void 0 ? { piecesCompleted } : {}
    });
  }
  async handleReadyToDispatched(job, tenantId) {
    if (job.tailorId) {
  ...
  async handleCancellation(job, tenantId) {
...
__name(TransitionService, "TransitionService");
...
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
init_performance2();
var fabricLinkSchema = external_exports.object({
  fabricId: external_exports.string().uuid(),
  metersReserved: external_exports.number().min(0.01)
});
var createJobSchema = external_exports.object({
  designId: external_exports.string().uuid().optional(),
  tailorId: external_exports.string().uuid().optional(),
  priority: external_exports.enum(["LOW", "NORMAL", "HIGH", "URGENT"]).optional().default("NORMAL"),
  piecesExpected: external_exports.number().int().min(1),
  dueDate: external_exports.string().optional(),
  notes: external_exports.string().max(500).optional(),
  fabricLinks: external_exports.array(fabricLinkSchema).optional().default([])
});
var updateJobSchema = external_exports.object({
  designId: external_exports.string().uuid().optional(),
  tailorId: external_exports.string().uuid().optional(),
  priority: external_exports.enum(["LOW", "NORMAL", "HIGH", "URGENT"]).optional(),
  piecesExpected: external_exports.number().int().min(1).optional(),
  piecesCompleted: external_exports.number().int().min(0).optional(),
  dueDate: external_exports.string().optional(),
  notes: external_exports.string().max(500).optional(),
  fabricLinks: external_exports.array(fabricLinkSchema).optional()
});
var transitionJobSchema = external_exports.object({
  targetStatus: external_exports.enum(["DRAFT", "CUTTING", "SEWING", "READY", "DISPATCHED", "CANCELED"]),
  metersUsed: external_exports.array(
    external_exports.object({
      fabricId: external_exports.string().uuid(),
      metersUsed: external_exports.number().min(0),
      metersWasted: external_exports.number().min(0).optional().default(0)
    })
  ).optional(),
  piecesCompleted: external_exports.number().int().min(0).optional()
});
var createDesignSchema = external_exports.object({
  name: external_exports.string().min(1).max(100),
  targetAudience: external_exports.string().max(100).optional(),
  sizeConfigJson: external_exports.string().optional().default("{}")
});
var updateDesignSchema = external_exports.object({
  name: external_exports.string().min(1).max(100).optional(),
  targetAudience: external_exports.string().max(100).optional(),
  sizeConfigJson: external_exports.string().optional()
});
...
var DashboardService = class {
  ...
  async getDashboard(tenantId) {
    ...
    const activeStatuses = ["DRAFT", "CUTTING", "SEWING", "READY"];
    ...
    const allStatuses = ["DRAFT", "CUTTING", "SEWING", "READY", "DISPATCHED", "CANCELED"];
    for (const s of allStatuses) {
      jobsByStatus[s] = jobsByStatus[s] ?? 0;
    }
    const delayedJobs = allJobs.filter(
      (j) => j.dueDate && j.dueDate < today && !["DISPATCHED", "CANCELED"].includes(j.status)
    ).length;
    ...
    const recentJobs = allJobs.sort((a, b) => b.createdAt.localeCompare(a.createdAt)).slice(0, 10).map((j) => ({
      id: j.id,
...
__name(DashboardService, "DashboardService");
...
var DesignService = class {
  ...
  async update(id, tenantId, input) {
    ...
    return this.designRepo.update(id, tenantId, {
      ...
      ...input.sizeConfigJson !== void 0 && { sizeConfigJson: input.sizeConfigJson }
    });
  }
  async delete(id, tenantId) {
    await this.designRepo.findByIdOrThrow(id, tenantId);
...
__name(DesignService, "DesignService");

// src/routes/designs.ts
var designs2 = new Hono2();
designs2.get("/", async (c) => {
  const db = createDb(c.env.DB);
  const service = new DesignService(new DesignRepository(db));
  const data = await service.list(c.get("tenantId"));
  return ok(c, data);
});
designs2.get("/:id", async (c) => {
  const db = createDb(c.env.DB);
  const service = new DesignService(new DesignRepository(db));
  const data = await service.getById(c.req.param("id"), c.get("tenantId"));
  return ok(c, data);
});
designs2.post("/", zValidator("json", createDesignSchema), async (c) => {
  const db = createDb(c.env.DB);
  const service = new DesignService(new DesignRepository(db));
  const data = await service.create(c.get("tenantId"), c.req.valid("json"));
  return created(c, data);
});
designs2.patch("/:id", zValidator("json", updateDesignSchema), async (c) => {
  const db = createDb(c.env.DB);
  const service = new DesignService(new DesignRepository(db));
  const data = await service.update(c.req.param("id"), c.get("tenantId"), c.req.valid("json"));
  return ok(c, data);
});
designs2.delete("/:id", async (c) => {
  const db = createDb(c.env.DB);
  const service = new DesignService(new DesignRepository(db));
  await service.delete(c.req.param("id"), c.get("tenantId"));
  return noContent(c);
});
var designs_default = designs2;
...
api.route("/fabrics", fabrics_default);
api.route("/tailors", tailors_default);
api.route("/jobs", jobs_default);
api.route("/dashboard", dashboard_default);
api.route("/designs", designs_default);
app.route("/api", api);
